...
class Rectangle{
    ...
    public:
        ...
        friend ostream & operator<<(ostream &, const Rectangle<X, Y> &);
};
int main(){
    //printData(12);
    //printData(12.99);
...
template<typename T, typename U>
ostream &operator<<(ostream &strObj, const Rectangle<T, U> &recObj){
    cout << "Ostream operator <<\n"
        << "Length: " << recObj.l << endl
        << "Width: " << recObj.w << endl;
    return(strObj);
}